...
public class TlsFactory(IOptions<NetworkConfig> config) : IPresentationFactory<GeminiRequestMetadata>
{
    ...
    public IPresentation CreateAndUpdateMetadata(Stream stream, GeminiRequestMetadata metadata)
    {
